%
% Manual.tex
% Mini Manual main document formatting
%
...
\newif\ifcura\curafalse %false, to test inserting Cura prior to the other software packages. 
\newif\ifslicer\slicertrue %true
\newif\iffilament\filamentfalse %false
\newif\iffirstprint\firstprintfalse %false
\newif\ifglcd\glcdfalse %false - not present on the Mini
...
\ifrendereverything \titletrue \copyrighttrue \warningstrue \setuptrue \curatrue \slicertrue \softwaretrue \glcdfalse \filamenttrue \firstprinttrue \maintenancetrue \advancedtrue \faqtrue \troubleshootingtrue \colophontrue \fi
%%% END INCLUDED FILES %%%
...
\usepackage{eledmac}
%% Use eledmac for compiling on *nix
%% Use ledmac for compiling on debian As of Jun 2014: Using package `ledmac' is deprecated. We suggest using `eledmac' instead.
%\usepackage{ledmac}
...
\thispagestyle{empty}
\markboth{Setup Your Printer}{LulzBot\textsuperscript{\miniscule{\texttrademark}} Mini User Manual}
{\include{Setup}}
\fi
%%% END SETUP %%%
...
\thispagestyle{empty}
\markboth{Loading Filament}{LulzBot\textsuperscript{\miniscule{\texttrademark}} Mini User Manual}
{\include{Filament}}
\fi
%%% END FILAMENT %%%
...
\thispagestyle{empty}
\markboth{3D Printer Software}{LulzBot\textsuperscript{\miniscule{\texttrademark}} Mini User Manual}
{\include{Software}}
\fi
%%% END SOFTWARE %%%
...
\chapter{\emph{Cura}}
\thispagestyle{empty}
\markboth{Cura}{LulzBot\textsuperscript{\miniscule{\texttrademark}} TAZ User Manual}
{\include{Cura}}
\fi
%%% END CURA %%%
...
\thispagestyle{empty}
\markboth{Hardware and Software Source Code}{LulzBot\textsuperscript{\miniscule{\texttrademark}} Mini User Manual}
{\include{Source}}
\fi
%%% END SOURCE %%%
...
\thispagestyle{empty}
\markboth{3D Printer Support}{LulzBot\textsuperscript{\miniscule{\texttrademark}} Mini User Manual}
{\include{Support}}
\fi
%%% END SUPPORT %%%
...
\thispagestyle{empty}
\markboth{Contact Information}{LulzBot\textsuperscript{\miniscule{\texttrademark}} Mini User Manual}
{\include{Contact}}
\fi
%%% END CONTACT %%%
