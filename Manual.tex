...
%% The above thread had no progress or follow up from ShareLated support. %%
...
\newif\ifregulatory\regulatorytrue %true
...
\ifrendereverything \titletrue \copyrighttrue \warningstrue \setuptrue  \softwaretrue \curatrue \printruntrue \slicertrue \filamenttrue \firstprinttrue \maintenancetrue \advancedtrue \faqtrue \troubleshootingtrue \sourcetrue \supporttrue \warrantytrue \regulatorytrue \notestrue \colophontrue \fi
%%% END INCLUDED FILES %%%
...
\thispagestyle{empty}
\markboth{Regulatory Statements}{LulzBot Mini User Manual}
{\include{Regulatory}}
\fi
%%% END REGULATORY %%%
...
\thispagestyle{empty}
\markboth{3D Printer Software}{LulzBot Mini User Manual}
{\include{Software}}
\fi
%%% END SOFTWARE %%%
...
\thispagestyle{empty}
\markboth{Cura LulzBot Edition}{LulzBot Mini User Manual}
{\include{Cura}}
\fi
%%% END CURA %%%
...
\label{firstprint}
\thispagestyle{empty}
\markboth{Your First 3D Print}{LulzBot Mini User Manual}
{\include{Firstprint}
\fi
%%% END FIRSTPRINT %%%
...
\thispagestyle{empty}
\markboth{Maintaining Your 3D Printer}{LulzBot Mini User Manual}
{\include{Maintenance}}
\fi
%%% END MAINTENANCE %%%
...
\thispagestyle{empty}
\markboth{Advanced Usage}{LulzBot Mini User Manual}
{\include{Advanced}}
\fi
%%% END ADVANCED %%%
...
\thispagestyle{empty}
\markboth{Hardware and Software Source Code}{LulzBot Mini User Manual}
{\include{Source}}
\fi
%%% END SOURCE %%%
...
\thispagestyle{empty}
\markboth{3D Printer Support}{LulzBot Mini User Manual}
{\include{Support}}
\fi
%%% END SUPPORT %%%
...
\thispagestyle{empty}
\markboth{Warranty Information}{LulzBot Mini User Manual}
{\include{Warranty}}
\fi
%%% END SUPPORT %%%
...
\thispagestyle{empty}
\markboth{Contact Information}{LulzBot Mini User Manual}
{\include{Contact}}
\fi
%%% END CONTACT %%%
