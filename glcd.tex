...
%
%
%%%% This module is turned off for the Mini, as it's not shipping with the GLCD. %%%%
...
\section{\texttt{GLCD Controller or Printrun Host?}}
...
\subsection{\texttt{GLCD Controller Menu Diagram}}
\begin{figure}[H]
\centering
