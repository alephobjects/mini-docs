...
%%% This section is turned off in Manual.tex for Gladiola Mini %%%
...
This sets the maximum acceleration for retraction moves of the extruder. If this value is set too high it can lead to stripping. Excessively low values can lead to poor print quality. We have this set to 3000mm/s\textsuperscript{\miniscule{2}} by default.
