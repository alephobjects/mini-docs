...
\index{filament}
Choose your desired filament. The Lulzbot Mini ships with a 1 meter sample of HIPS, and should be used in your first print.
...
\index{Full Settings}
\textcolor{red}{Full settings should not be used until a decent amount of 3D printing experience has been acquired. The simple settings will provide good results for most models.}
