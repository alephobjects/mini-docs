...
\subsubsection{\texttt{From LulzBot}} % (fold)
...
\subsubsection{\texttt{Slic3r}} % (fold)
\label{sub:slic3r}
...
\subsubsection{\texttt{Manual}} % (fold)
\label{sub:manual}
...
\subsubsection{\texttt{Source}} % (fold)
\label{sub:source}
...
\subsection{\texttt{Building from source}} % (fold)
