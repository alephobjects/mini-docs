...
\subsubsection{\texttt{Finding Models}} % (fold)
...
\subsubsection{\texttt{Working with Plater}} % (fold)
...
\subsubsection{\texttt{Cleaning STLs}} % (fold)
