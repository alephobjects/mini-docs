...
To decrease the Z-offset between your nozzle tip and the plate, subtract from your current offset when changing XXX. To increase the Z-offset between the nozzle tip and the plate add to your current offset when changing XXX. When updating your offset, be sure to make small changes between prints. +/- 0.1mm incriments at a time when making adjustments is recommended. 
