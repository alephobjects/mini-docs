...
\label{ssec:num2}
We include the latest version of 3D printer firmware with each update of Cura LulzBot Edition. to update your firmware:
\begin{itemize}
\item Download the latest version of Cura from \texttt{LulzBot.com/Cura}.
...
\item Add a new machine by going to \texttt{Machine > Add New Machine}.
\item Select \texttt{LulzBot Mini}.
\item Select the appropriate tool head.
\item Install firmware by going to \texttt{Machine > Install Default Firmware}
\end{itemize}

You now have the latest stable firmware for your LulzBot Mini.
