...
\begin{center}
%%{\huge \scshape Mini User Manual}
\fontspec{Outage.ttf}\fontsize{24pt}{1em}\selectfont Mini User Manual
...
%%% SET TITLE FONT
\includegraphics[keepaspectratio=true,angle=0,height=1.0\textheight,width=1.0\textwidth]{mini.jpg}
