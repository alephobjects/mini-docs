...
\index{electronics}
\index{fan}
The electronics case holding the RAMBo board may need dust blown out occasionally. If dust is evident on the control box vents, unplug the printer and use short bursts of compressed air to blow out any dust. \textcolor{red}{Never open the electronics enclosure when when plugged in, as there may be high voltage present.}
